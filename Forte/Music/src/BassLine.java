...
public class BassLine extends RTLine implements JMC{
    ...
    public synchronized void externalAction(Object obj, int actionNumber) {
        ...
        //I wrote this elif and it somehow changes cutoff.
//        else if (actionNumber == 2) {
//            JSlider slider = (JSlider) obj;
//            double filterDynamic = (double) (slider.getValue() * 100);
//            for (int i = 0; i < inst.length; i++) {
//                double[] values = {filterDynamic};
//                inst[i].setController(values);
//
//            }
//        }
