...
public class ForteSong6b extends RTLine implements JMC{
    ...
    private int[] melodyPitchArray = new int[] {REST , REST, BF4, REST, REST, BF4,       REST, BF4, REST,   REST , REST, BF4, REST, REST, BF4, REST, BF4, REST, REST , REST, BF4, REST, REST, BF4, REST, BF4, REST, BF4, BF4, REST, C4, REST, C4, REST, BF4, BF4, BF4};
     ...
     * Constructor
     */
    public ForteSong6b(Instrument[] instArray) {
        super(instArray);
    }
