...
public final class BreathyLPFInstRT2 extends Instrument{
    //----------------------------------------------
    // Attributes
    //----------------------------------------------
     ...
     * @param sampleRate
     */
    public BreathyLPFInstRT2(int sampleRate){
     ...
     */
    public BreathyLPFInstRT2(int sampleRate, int filterCutoff){
     ...
     */
    public BreathyLPFInstRT2(int sampleRate, int filterCutoff, int channels){
    ...
    public void createChain(){
        Oscillator wt = new Oscillator(this, Oscillator.BREATHNOISE, this.sampleRate, this.channels);
